"""Adds config flow for Zeekr EU Integration."""
...
class ZeekrEUFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):  # type: ignore[call-arg]
    """Config flow for Zeekr EU Integration."""
    ...
    def async_get_options_flow(config_entry):
        return ZeekrEUOptionsFlowHandler(config_entry)
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(
                        CONF_COUNTRY_CODE,
                        default=defaults.get(CONF_COUNTRY_CODE, "CH"),
...
class ZeekrEUOptionsFlowHandler(config_entries.OptionsFlow):
    """Config flow options handler for Zeekr EU Integration."""
